...
class Piklist_Theme
{
  ...
  public static function assets($assets)
  {
    ...
    array_push($assets['scripts'], array(
      'handle' => 'piklist'
      ,'src' => plugins_url('act/piklist/parts/js/piklist.js')
      ,'ver' => piklist::$version
      ,'deps' => array(
        'jquery'
        ,'jquery-ui-sortable'
    ...
    array_push($assets['scripts'], array(
      ...
      ,'src' => plugins_url('act/piklist/parts/js/jquery.placeholder.js')
      ,'ver' => '1.0'
      ,'deps' => 'jquery'
      ,'enqueue' => true
      ,'in_footer' => true
    ...
    array_push($assets['styles'], array(
      'handle' => 'piklist-css'
      ,'src' => plugins_url('act/piklist/parts/css/piklist.css')
      ,'ver' => piklist::$version
      ,'enqueue' => true
      ,'admin' => true
      ,'in_footer' => false
