...
class Piklist_Form
{
  ...
  public static function render_field_assets()
  {
    ...
    if (!empty($field_types_rendered))
    {
      ...
      wp_register_style('jquery-ui-core', plugins_url('act/piklist/parts/css/jquery-ui/jquery-ui.css'), false, $jquery_ui_core->ver);
      wp_register_style('jquery-ui-core-piklist', plugins_url('act/piklist/parts/css/jquery-ui.piklist.css'), false, piklist::$version);
  ...
  public static function remove_theme_css($mceInit, $editor_id)
  {
    ...
    if ($editor_id != 'content' && substr($editor_id, 0, strlen($prefix)) !== $prefix)
    {
      ...
      array_push($content_css,  plugins_url('act/piklist/parts/css/tinymce-piklist.css'));
