...
function acttable_assets() {
    wp_enqueue_style( 'icons', plugins_url('act/assets/css/fontawesome-all.min.css'), array(), '1.0.0', 'all' );
    wp_enqueue_style( 'act-css', plugin_dir_url(__FILE__)."assets/act-tbl-style.css", array());
...
//Require Files
require_once(dirname(__FILE__) . '/inc/act-product-ui.php');
require_once(dirname(__FILE__) . '/inc/act-product-shortcode.php');
require_once(dirname(__FILE__) . '/inc/act-three-product-box-ui.php');
require_once(dirname(__FILE__) . '/inc/act-three-product-box-shortcode.php');
...
require_once(dirname(__FILE__) . '/shortcode-ui/shortcode-ui.php');